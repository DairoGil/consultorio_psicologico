...
pipeline{
    ...
    environment {
        PROJECT_PATH_BACK = 'consultorio-psicologico'
    }
    ...
    stages{
        stage('Checkout') {
            steps {
                ...
                gitCheckout(
                    urlProject:'https://github.com/DairoGil/consultorio_psicologico.git',
		...
		stage('Static Code Analysis') {
			steps{
				...
				sonarName:'co.com.ceiba.proyecto:consultoriopsicologico', 
